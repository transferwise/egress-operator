...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalServiceDeploymentSpec) DeepCopyInto(out *ExternalServiceDeploymentSpec) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalServiceDeploymentSpec.
func (in *ExternalServiceDeploymentSpec) DeepCopy() *ExternalServiceDeploymentSpec {
	if in == nil {
		return nil
	}
	out := new(ExternalServiceDeploymentSpec)
	in.DeepCopyInto(out)
	return out
}
